...
import { CarouselControls, MagnetControl } from "./CanvasControls";
...
export default function CanvasWorkspace({
    ...
    useEffect(() => {
        const calculateScale = () => {
            ...
            const verticalPadding = isMobile ? 24 : DESKTOP_CANVAS_VERTICAL_GUTTER;
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <MagnetControl active={isMagnetActive} accentColor={accentColor} onChange={setMagnetActive} />
                </div>

                {isCarousel && <CarouselControls slides={slides} index={currentSlideIndex} scope={applyScope} accentColor={accentColor} onIndexChange={setCurrentSlideIndex} onScopeChange={setApplyScope} />}
            </div>
        </div>
    );
}
