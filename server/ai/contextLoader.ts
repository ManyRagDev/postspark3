/**
 * contextLoader.ts — movido de server/ai/highTicket/contextLoader.ts (Fase D).
 *
 * Carrega BrandKit + Persona + SiteIntelligence em paralelo e monta um
 * MasterBriefing canônico com context budget aplicado. Quando BrandKit ou
 * Persona estão ausentes, usa fallbacks limpos (não bloqueia a geração).
 */
import type { MasterBriefing, ContextLoaderInput } from "@shared/contextBriefing";
